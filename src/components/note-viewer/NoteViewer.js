      ...
      <div className="flex flex-col mb-8">
        {isEditing ? (
          <input
            ...
            className="text-[2rem] font-bold border border-surface rounded p-2 mb-2 bg-base text-foreground outline-none w-full"
      ...
      <div>
        {isEditing ? (
          <textarea
            ...
            className="w-full min-h-[400px] border border-surface rounded p-4 bg-base text-foreground font-[inherit] text-base resize-y outline-none"
    ...
    <div className="flex-1 overflow-y-auto p-8">
      <div className="flex flex-col mb-8">
        {isEditing ? (
          ...
          <h1 className="text-[2rem] font-bold mb-2 text-foreground">{note.title}</h1>
        )}
        <div className="flex gap-4 mb-4 flex-wrap">
          <span className="text-muted text-sm">Created: {formatDate(note.createdAt)}</span>
          {note.updatedAt && note.updatedAt !== note.createdAt && (
